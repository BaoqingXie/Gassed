class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.atlas('Restart', 'Restart.png', 'Restart.json');
    ...
    create() {
        ...
        //selection to restart or to the menu
    ...
    update() {
        ...
        if (this.player1.x < -this.player1.width / 2 || this.playerdeath == 1) {
            //game over
            this.playerdeath = 2; //incase it did not repeat
            ...
            this.Back = this.add.sprite(centerX, centerY + 50, 'Back', 1).setScale(0.7, 0.7);
    ...
    printTime() {
        if (gameSpeed > 0) {
            this.text.setText('Score: ' + this.timescores + 'm');
            this.timescores += 1;
        }
    }
